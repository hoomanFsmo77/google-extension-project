...
var Api = /*#__PURE__*/function () {
  function Api() {
    ...
    _classPrivateFieldSet(this, _url, 'https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?CMC_PRO_API_KEY=');
    _classPrivateFieldSet(this, _key, 'c61e0f1a-edac-4164-9185-6d4987107505');
    this.request = null;
    this.response = null;
    this.start();
  }
...
function _url() {
  const data = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'url'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
function _assert() {
  const data = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
function _util() {
  const data = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'util'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
